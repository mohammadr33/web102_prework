...
function addGamesToPage(games) {
    ...
    // loop over each item in the data
        for (let game of games) {
            ...
            <p><strong>Pledged: $${game.pledged}</strong></p>`;
...
const summary = `
    A total of $${totalRaised.toLocaleString()} has been raised across ${totalGames} game${totalGames !== 1 ? 's' : ''}.
    Currently, ${numberOfUnfundedGames} game${numberOfUnfundedGames!== 1 ? 's' : ''} remain unfunded.
`;
